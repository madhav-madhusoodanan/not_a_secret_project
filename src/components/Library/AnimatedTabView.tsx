...
export const ComTabViewOffset =
  Platform.OS === 'ios' ? -Theme.sizing.header : 0;

export interface ComAnimatedTabViewProps<T>
  extends ViewProps,
    Pick<
      FlatListProps<T>,
      | 'data'
...
const ComAnimatedTabViewWithoutMemo = <T extends any>({
  data,
  renderItem,
  getItemLayout,
  onContentSizeChange,
...
export const ComAnimatedTabView = memo(
  ComAnimatedTabViewWithoutMemo,
) as typeof ComAnimatedTabViewWithoutMemo;
